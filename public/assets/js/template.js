...
(function($) {
  ...
  $(function() {
    ...
    // Check if the banner cookie exists and its value is not "true"
    const bannerCookie = $.cookie('staradmin2-free-banner');
    ...
    // Check if the navbar has the class 'fixed-top'
    const navbar = document.querySelector('.navbar');
